class Repeatprof < Formula
  ...
  def install
    ...
    system "Rscript", "-e", "install.packages(c('ggplot2','reshape2','scales','ggpubr','pillar','crayon'),dep=TRUE,repos = c('http://rstudio.org/_packages','http://cran.rstudio.com'),lib='R_packages')"
